...
static const char *const yytname[] =
{
  ...
  "INT", "BOOL", "IF", "ELSE", "WHILE", "PRINT", "TRUE", "FALSE", "ASSIGN",
  "EQ", "NE", "GT", "LT", "AND", "OR", "';'", "$accept", "program",
...
{
      14,    15,    11,    12,     1,     2,     3,    13,    16,    17,
       4,    19,    21,    22,    23,    20,    24
};

static const yytype_int8 yycheck[] =
{
       3,     4,    13,     4,     4,     5,     6,     4,    11,    12,
      10,     0,    20,    20,    20,     6,    11
};
...
{
       0,     4,     5,     6,    10,    22,    23,    24,    25,    26,
      27,    13,     4,     4,     3,     4,    11,    12,    28,     0,
      24,    20,    20,    20,    28
};
...
#line 37 "src/parser/parser.y"
                             { std::cout << "Parsed declaration: int " << (yyvsp[0].str) << std::endl; free((yyvsp[0].str)); }
#line 1100 "src/parser/parser.tab.cpp"
    break;

  case 9: /* declaration: BOOL IDENTIFIER  */
#line 38 "src/parser/parser.y"
                              { std::cout << "Parsed declaration: bool " << (yyvsp[0].str) << std::endl; free((yyvsp[0].str)); }
#line 1106 "src/parser/parser.tab.cpp"
    break;

  case 10: /* assignment: IDENTIFIER ASSIGN expression  */
#line 41 "src/parser/parser.y"
                                          { std::cout << "Parsed assignment: " << (yyvsp[-2].str) << " = ..." << std::endl; free((yyvsp[-2].str)); }
#line 1112 "src/parser/parser.tab.cpp"
    break;

  case 11: /* print_stmt: PRINT expression  */
#line 44 "src/parser/parser.y"
                              { std::cout << "Parsed print statement" << std::endl; }
#line 1118 "src/parser/parser.tab.cpp"
    break;

  case 13: /* expression: IDENTIFIER  */
#line 48 "src/parser/parser.y"
                        { free((yyvsp[0].str)); }
#line 1124 "src/parser/parser.tab.cpp"
    break;


#line 1128 "src/parser/parser.tab.cpp"
